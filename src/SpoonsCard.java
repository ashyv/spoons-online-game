...
/**
 * An object of type SpoonsCard represents a playing card from a
 * standard Poker deck, not including Jokers. The card has a suit, which
...
public class SpoonsCard implements Serializable {
    ...
    * Permissible ranges
    */
   public SpoonsCard(int theValue, int theSuit) {
   ...
   public boolean equals(Object obj) {
      if (obj == null || !(obj instanceof SpoonsCard))
         return false;
      SpoonsCard that = (SpoonsCard)obj;
